...
namespace Kennedy.UnityEditorUtility.ScriptableSingletons
{
    public class ScriptablesSingletonWindow : EditorWindow
    {
        ...
        private const string k_AssetsPath = @"Packages\com.kennedyvnak.scriptable-singletons\Editor\";
        private const string k_TemplatePath = k_AssetsPath + "ScriptableSingletons.uxml";
        private const string k_ItemObjectTemplatePath = k_AssetsPath + "ScriptableSingletons-ItemObject.uxml";
